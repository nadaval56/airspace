...
#
#   1. **תקציב הזמן הוא הרסן, לא ספירת ההודעות.** התקרה גבוהה
#      בכוונה, והעצירה מגיעה מהשעון: כשהשרת מהיר נכנסות הרבה
#      הרחבות, וכשהוא מאט הריצה נעצרת מוקדם מעצמה. זה מווסת את עצמו
#      מול העומס בצד השני, במקום לנחש מספר קבוע.
...
MAX_EXPANSIONS_PER_RUN = 40
EXPANSION_BUDGET_SECONDS = 120
EXPANSION_DELAY = 1.5
